...
console.log(tienenMismaLongitud("pedro", "lucas"));
...
function elevarAlCubo(num) {
  ...
  // Tu código:
  let cuadrado = elevarAlCuadrado(num);
  return multiplica(cuadrado, num);
}
...
console.log(redondearNumero(10.2));
...
console.log(redondearHaciaArriba(10.2));
...
console.log("esPositivoONegativo");
...
console.log(combinarNombres("Ignacio ", "Perez"));
...
console.log(obtenerSaludo("ignacio"));

function obtenerAreaRectangulo(alto, ancho) {
  // Retornar el area de un rectángulo teniendo su altura y ancho
  // Tu código:
  //aca elevo al cuadrado la altura
  let altoAlCuadrado = elevarAlCuadrado(alto);
  //aca ejecuto el calculo del area
  let area = ancho * altoAlCuadrado;
  return area;
}
